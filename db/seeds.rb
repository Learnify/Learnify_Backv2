...
User.create(name: 'Julian', last_name: 'Moreno', email: "bjmorenon@unal.edu.co", password_digest: "123456HOLA", career: career.first)
	...
	Article.create( title:"Programación con ruby", body:"este es un articulo de programacion ruby", visits_count: 2 , imagen: "asd.jpg", user_id: 1)
	...
	Article.create( title:"Cura del cancer", body:"Articulo de como modelar interiores", visits_count: 2 , imagen: "asd2.jpg", user_id: 2)
	...
	Article.create( title:"Modelado de interiores", body:"Articulo de como modelar interiores", visits_count: 22 , imagen: "asd3.jpg", user_id: 3)
	...
	Article.create( title:"Lamusica es el espejo de la mente", body:"este articulo nos habla de la relacion entre el cerebro y la musica", visits_count: 222 , imagen: "asd.jpg", user_id: 4)
	...
	Article.create( title:"Particulas subatomicas", body:"este articulo nos habla de particulas subatomicas (bariones)", visits_count: 222 , imagen: "asd.jpg", user_id: 4)
